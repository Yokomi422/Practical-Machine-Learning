...
const Star = (props) => {
  ...
  return (
    <path
      d="M10,1 13,8 21,8 15,12 18,19 10,14 2,19 5,12 -1,8 7,8z"
...
return (
    <line
    x1={line.x * 500}  // 500 is the width of the chart
    y1={line.y1 * 300} // 300 is the height of the chart
    x2={line.x * 500}
    y2={line.y2 * 300}
    stroke="black"
    strokeWidth="2"
...
const StarDotChart = () => (
  ...
  >
    ...
    <Scatter
      name="Stars"
      data={data.filter((d) => d.shape === "star")}
      fill="#8884d8"
      shape={<Star />}
    />
    <Scatter
      name="Dots"
      data={data.filter((d) => d.shape === "dot")}
      fill="#8884d8"
      shape={<Dot />}
    />
    <ReferenceLine y={0.4} stroke="red" />
    <CustomLine line={{ x: 0.3, y1: 0, y2: 0.4 }} />
    <CustomLine line={{ x: 0.5, y1: 0.4, y2: 1 }} />
  </ScatterChart>);
